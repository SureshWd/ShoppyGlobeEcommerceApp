    ...
    <div className="px-4 sm:px-8 md:px-16 lg:px-24 min-h-screen py-8 bg-gray-50 ">
      <div className="max-w-md mx-auto bg-white shadow-lg rounded-lg p-6">
        <h2 className="text-2xl  text-gray-800 mb-4 font-bold">
          Check<span className="text-[#4fb6a8]">Out</span>
        </h2>
        <h2 className="font-semibold mb-6 text-gray-700 text-lg  ">
          Total Amount: <span className="text-[#4fb6a8]">${cartPrice}</span>
        </h2>
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full mt-4 bg-[#4fb6a8] text-white font-bold py-2 rounded-lg hover:bg-[#3a9288] transition"
          >
            Submit
          </button>
        </form>
