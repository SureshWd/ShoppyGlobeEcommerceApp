...
function Header() {
  ...
  return (
    <nav className=" font-Amaranth border-b-8 relative border-[#4fb6a8] font-cfont py-4 shadow-lg px-3 xs:px-8    flex items-center justify-between">
      ...
      >
        <li className="hover:text-[#4fb6a8] hover:underline cursor-pointer">
          <Link to={"/"}>Home</Link>
        </li>
        <li className="hover:text-[#4fb6a8] hover:underline cursor-pointer">
